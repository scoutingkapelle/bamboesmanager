...
constraint.max=Maximale waarde: {0}
constraint.minLength=Minimale lengte: {0}
constraint.maxLength=Maximale lengte: {0}
constraint.email=Emailadres

# --- Errors
error.invalid=Ongeldige waarde
error.required=Dit veld is verplicht
error.number=Numerieke waarde verwacht
error.min=Moet groter of gelijk aan {0} zijn
error.min.strict=Moet groter dan {0} zijn
error.max=Moet kleiner of gelijk aan {0} zijn
error.max.strict=Moet kleiner dan {0} zijn
error.minLength=Minimale lengte is {0}
error.maxLength=Maximale lengte is {0}
error.email=Geldig emailadres verplicht
error.uuid=Ongelgide UUID